...
public class UserOutfitController implements Serializable {
    ...
    public DataModel getItems() {
        ...
        Iterator<UserOutfit> userOutFitItr=items.iterator();
        while (userOutFitItr.hasNext()) {
            UserOutfit outfit = userOutFitItr.next();
            if(UserGroups.USERS_GROUP.equals(user.getRole()) &&!outfit.getUser().equals(user)){
                //userOutFitItr.remove();
            }
        }return items;
    }
